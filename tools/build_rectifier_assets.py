...
box('tabard_mark', 'body', [-0.5, 4, -4.9], [1, 7, 1], 'brass')
...
box('left_forearm', 'left_arm', [8, -1, -3], [6, 7, 6], 'stone')
...
box('hammer_head', 'hammer', [8.5, 12, -5], [5, 4, 8], 'stone')
box('hammer_striking_left', 'hammer', [8.5, 12, 3], [5, 4, 1], 'joint')
box('hammer_striking_right', 'hammer', [8.5, 12, -6], [5, 4, 1], 'joint')

shells = {'chest_left': 0.04, 'chest_right': 0.04, 'belt': 0.04, 'buckle': 0.06, 'crown': 0.04, 'vertical_visor': 0.04, 'cheek_right': 0.06, 'cheek_left': 0.06, 'right_greave_band': 0.04, 'left_greave_band': 0.04, 'hammer_grip': 0.04, 'hammer_collar': 0.06, 'hammer_striking_left': 0.04, 'hammer_striking_right': 0.04, 'chest_socket': 0.02}
for c in cubes:
