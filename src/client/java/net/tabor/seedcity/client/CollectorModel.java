...
public final class CollectorModel extends EntityModel<ArmedEntityRenderState> implements ArmedModel<ArmedEntityRenderState> {
    private final ModelPart body,torso,head,rightArm,leftArm,rightLeg,leftLeg;
    public CollectorModel(ModelPart root) {
        super(root); body=root.getChild("body");torso=body.getChild("torso");head=torso.getChild("head");
    ...
    @Override public void setupAnim(ArmedEntityRenderState state) {
    ...
    @Override public void translateToHand(ArmedEntityRenderState state,HumanoidArm side,PoseStack stack) {
